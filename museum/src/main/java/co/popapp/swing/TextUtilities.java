...
public class TextUtilities {
    ...
    public static void drawOutlinedText(
        Graphics gfx, int x, int y, String text, int outlineOffset, Color outlineColor) {
    ...
    public static void drawShadowedText(
        Graphics gfx, int x, int y, String text, int shadowXOffset, int shadowYOffset, Color shadowColor) {
    ...
    public static void drawStripedText(
        Graphics gfx, int x, int y, String text, int separtion, Color stripesColor) {}

    /**
     * @param fontsDir .
     * @throws java.io.FileNotFoundException e.
     * @throws java.io.IOException e.
     * @throws java.awt.FontFormatException e.
     */
    @Deprecated public static void loadFonts(File fontsDir)
