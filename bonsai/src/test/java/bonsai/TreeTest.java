...
import static bonsai.Model.City.city;
import static bonsai.Model.Continent.continent;
import static bonsai.Model.Country.country;
...
import bonsai.Model.City;
import bonsai.Model.Continent;
import bonsai.Model.Country;
...
public class TreeTest {
    ...
    private static TreeNode<?> buildCityTree (List<City> aCities) {
        final TreeNode<?> cityTree = TreeNode.buildTree (aCities, new TreeBuilder<City> () {
    ...
    @Test public void declarativeTree () {
        final TreeNode<String> cityTree =
            new TreeNode<String> ("Europe",
                new TreeNode<String> ("Spain",
                    new TreeNode<String> ("Madrid"),
                    new TreeNode<String> ("Barcelona")
                ),
                new TreeNode<String> ("Ireland",
                    new TreeNode<String> ("Dublin"),
                    new TreeNode<String> ("Galway")
                ),
                new TreeNode<String> ("Germany",
                    new TreeNode<String> ("Berlin"),
                    new TreeNode<String> ("Munich")
                )
            );
        out.println (cityTree);
    ...
    @Test public void treeWithLessLevelsRoot () {
        ...
        // Convert in tree
        TreeNode<?> tree = TreeNode.buildTree (cities, new TreeBuilder<City> () {
            @Override public List<?> list (City aEntity) {
