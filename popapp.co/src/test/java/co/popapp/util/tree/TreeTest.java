...
import static co.popapp.util.tree.TreeTest.PairTreeNode.list;
import static co.popapp.util.tree.TreeTest.PairTreeNode.map;
import static co.popapp.util.tree.TreeTest.PairTreeNode.entry;
...
public class TreeTest {
    ...
    static class PairTreeNode extends TreeNode<Pair<?, ?>> {
        public static PairTreeNode entry (Object key, Object value) {
            return null;
        }

        public static PairTreeNode map (Object key, PairTreeNode... children) {
            return null;
        }

        public static PairTreeNode list (Object key, Object... children) {
            return null;
        }
    }

    @Test public void PairTree () {
        list ("users",
            map ("")
        );
    }
